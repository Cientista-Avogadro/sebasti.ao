...
export function CVStandard({ locale, withPhoto }: CVProps) {
            ...
            <View style={styles.section}>
              ...
              {data.education.map((edu, index) => (
                <View key={index} style={styles.educationItem}>
                  ...
                  {'grade' in edu && <Text style={{ fontSize: 7, color: '#10b981' }}>{'grade' in edu ? edu.grade : ''}</Text>}
                  {'project' in edu && <Text style={{ fontSize: 7, color: '#666', fontStyle: 'italic' }}>{'project' in edu ? 'Project: ' + edu.project : ''}</Text>}
                </View>
              ))}
            </View>
