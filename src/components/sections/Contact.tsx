          ...
          >
            <div className="p-6 rounded-2xl bg-zinc-900/50 border border-zinc-800">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-zinc-300 font-medium">{t("location")}</span>
              </div>
              <p className="text-zinc-100 font-display text-lg">{t("luanda")}</p>
              <p className="text-zinc-500 text-sm mt-1">{t("available")}</p>
            </div>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div className="flex-1">
                  <div className="text-zinc-100 font-medium">Phone</div>
                  <div className="text-sm text-zinc-500">+244 972 745 066</div>
                </div>
              </a>
              <a
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm text-zinc-500">sebastiao-de-sousa-moniz</div>
                </div>
              </a>
              <a
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm text-zinc-500">@Cientista-Avogadro</div>
                </div>
              </a>
              <a
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm text-zinc-500">moniz.techs@gmail.com</div>
                </div>
              </a>
            </div>
          </motion.div>
