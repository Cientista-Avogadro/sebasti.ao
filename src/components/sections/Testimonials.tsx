...
const testimonials = [
  ...
  {
    quote: "É um ótimo profissional em desenvolvimento das aplicações, super recomendo em varias atividades. Trabalhar com o Cientista está a ser uma experiência muito boa.",
    author: "Adão Magalhães",
    role: "Frontend Developer | ReactJS | TailwindCSS",
    relation: "Trabalhou com Sebastião na GC-LUCAN",
    rating: 5,
  ...
  {
    quote: "The good programmer. So sponsor keep.",
    author: "Edmilson José Silvério",
    role: "Backend Engineer | Node.js | AWS",
    relation: "Trabalhou com Sebastião na Tecla T",
    rating: 5,
  ...
  return (
    <section className="relative py-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        >
          <span className="text-emerald-400 font-mono text-sm tracking-wider mb-4 block">08 — TESTIMONIALS</span>
          <h2 className="font-display text-4xl md:text-5xl font-bold mb-6 text-zinc-50">
            What Colleagues Say
          </h2>
          <p className="text-zinc-400 max-w-2xl mx-auto text-lg">
            Recommendations from professionals I've worked with.
          </p>
        </motion.div>
        ...
        <div className="relative max-w-4xl mx-auto">
              ...
              >
                <div className="p-8 md:p-12 rounded-2xl bg-zinc-900/50 border border-zinc-800 hover:border-emerald-500/30 transition-all relative">
                  <div className="absolute top-6 right-6 md:top-8 md:right-8">
                    <Quote size={48} className="text-emerald-500/20" />
                  </div>
                  ...
                  <div className="relative z-10">
                    ...
                    <blockquote className="text-lg md:text-xl text-zinc-300 leading-relaxed mb-8">
                      ...
                      {testimonials[currentIndex].photo ? (
                        ...
                        <div className="w-14 h-14 rounded-full bg-gradient-to-br from-emerald-500 to-emerald-600 flex items-center justify-center flex-shrink-0">
                          <span className="text-lg font-bold text-white">
                            {testimonials[currentIndex].author.split(' ').map(n => n[0]).join('').slice(0, 2)}
                          </span>
                        </div>
                      )}
                      <div>
          ...
          <div className="flex items-center justify-center gap-6 mt-8">
            <button
              onClick={prev}
              className="w-12 h-12 rounded-full border border-zinc-700 hover:border-emerald-500/50 hover:bg-emerald-500/10 flex items-center justify-center transition-all"
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full border border-zinc-700 hover:border-emerald-500/50 text-zinc-300 hover:text-emerald-400 transition-all"
          >
